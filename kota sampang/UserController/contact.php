    ...
    <div class="container flex-grow-1">
        <div class="row justify-content-center align-items-center">
            ...
            <div class="col-lg-5 py-0">
                <img src="http://localhost/kota%20sampang/img/contact.png" alt="Gambar Kontak" class="img-fluid hover-zoom">
            </div>
                ...
                <div class="card mb-4">
                    <div class="card-body text-start">
                        ...
                        <ul class="list-unstyled text-center">
                            <li>Email: aisyahnurff@gmail.com</li>
                            <li>Telepon: 081332772896</li>
                            <li>Alamat: Jl. Mertojoyo Selatang Gg 1, No. 17, Lowokwaru, Kota Malang</li>
                        </ul>
                        <p class="card-text text-center">
